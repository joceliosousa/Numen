  ...
  as projection on ZR_MAT_RME
{
  ...
  key Omrme,
      ...
      @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_DP_DMSDOCUMENT_STD'
      DmsDocumentUrl,
      DmsDocumentText,
      ...
      /* Associations */
      _TsoJtso       : redirected to composition child ZC_TSOJTSO_MAN,
      _MatCas        : redirected to composition child ZC_MAT_CAS_MAN,
      _CtrlMat       : redirected to composition child ZC_MAT_RME_CONTROL,
      _MatPrograma   : redirected to composition child ZC_MAT_RME_APL,
      _MatFornecedor : redirected to composition child ZC_MAT_RME_FORN,
      _MatParceiro   : redirected to composition child ZC_MAT_RME_PARC,
      _MatKit        : redirected to composition child ZC_MAT_RME_KIT
