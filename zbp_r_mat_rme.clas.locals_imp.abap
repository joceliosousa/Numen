  ...
  METHOD validateMandatoryFields.
    ...
    LOOP AT materiais INTO DATA(material).
      ...
      IF material-CodSitMat IS INITIAL OR
         ...
         material-CodOnu IS INITIAL.
*         material-GrpEmb IS INITIAL.
         "material-GrauRestricao IS INITIAL.
...
*          %element-GrpEmb         = COND #( WHEN material-GrpEmb IS INITIAL THEN if_abap_behv=>mk-on ELSE if_abap_behv=>mk-off )
*          %element-GrauRestricao  = COND #( WHEN material-GrauRestricao IS INITIAL THEN if_abap_behv=>mk-on ELSE if_abap_behv=>mk-off )
